...
require("db.php");
 ...
 try {
  ...
  $sql = "SELECT * FROM rapports WHERE respo= 'staff' ";
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        ...
        <a class="nav-link" href="my_homepage.php">Accueil</a>
    ...
    <ul class="nav navbar-nav navbar-right">
        ...
        <a class="nav-link" href="logout.php"><i class="gLyficon gLyficon-log-out"></i>  Déconnexion</a>
